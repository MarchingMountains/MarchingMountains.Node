...
router.get('/:id', function(req, res) {
    ...
    pg.connect(connection, function(err, client, done) {
        var query = client.query('SELECT * FROM schools ' +
            ...
            'WHERE user_id = $1 ORDER BY school_name ASC', directorID);
    ...
    pg.connect(connection, function(err, client, done) {
        client.query('INSERT INTO schools ' +
            ...
            for (var i = 0; i < instruments.length; i++) {
                ...
                console.log('instrument id result: ', instrument_id);
                client.query('INSERT INTO school_instruments (instrument_id, school_id) VALUES ($1, $2)', [instrument_id, school_id], function(err) {
                    client.end();
                });
            }
        });
